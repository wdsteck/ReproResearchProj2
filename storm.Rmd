---
title: Analysis of U.S. Severe Weather Events to Understand the Most Impactful on
...
```{R Convert EXP Variables to Numbers}
...
```{R Fatality Results, results = "asis"}
...
the most fatalities in the data provided is the `r top10$EVTYPE[1]` event.
...
```{R Cost Results, results="asis", comment=NA}
...
The event type reporting
the most economic impact in the data provided is the `r top10$EVTYPE[1]` event.
